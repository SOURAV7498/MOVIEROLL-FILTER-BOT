...
# Bot information
SESSION = environ.get('SESSION', 'the_inert_season')
API_ID = int(environ.get('API_ID', '21140176'))
API_HASH = environ.get('API_HASH', 'b081ec8da8cf5263a6593041c1ae2a3b')
BOT_TOKEN = environ.get('BOT_TOKEN', "8416344037:AAFbuPcxzUI_MSKw_C8kKNhfoo1TSRjPqlw")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6222491731').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002796911670').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '1003096722799') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1002669266714')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mahatobibek221034_db_files:jlPGQF189vnCYa8P@cluster0.v5weoma.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "theinertguy")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'inert_files')

MULTIPLE_DATABASE = bool(environ.get('MULTIPLE_DATABASE', False)) # Set True or False

# If Multiple Database Is True Then Fill All Three Below Database Uri Else You Will Get Error.
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://bibekkumarmahato0_dark-users:3w8Qr9F75N7G9nNP@cluster0.cyda7pu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://bibekkumarmahato0:Pfc2GoCd62hN4kRC@cluster0.lj1gbwg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://mahatobibek221034_db_files:jlPGQF189vnCYa8P@cluster0.v5weoma.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/ekL.jpg') # payment code picture url.
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '25e3fd19a4ac7dee2affd0c1890129b60c6be2d7')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/UniformHelp/1499/2096')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://grieving-arabela-strange12345678-a613a63a.koyeb.app/")
